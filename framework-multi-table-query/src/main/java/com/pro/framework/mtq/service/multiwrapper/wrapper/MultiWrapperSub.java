...
//import com.pro.framework.mtq.service.multiwrapper.wrapper.inner.MultiWrapperSubMainWhereInner;
...
public class MultiWrapperSub<SUB> {
    ...
    public static <SUB> MultiWrapperSub<SUB> lambda(Class<SUB> clazz) {
        return new MultiWrapperSub<>(new MultiWrapperSubInner<>(clazz));
    }
    ...
    public <VAL> MultiWrapperSub<SUB> ne(MultiFunction<SUB, VAL> prop, VAL value) {
        this.wrapperSubInner.ne(prop, value);
        return this;
    }
    ...
    public <VAL> MultiWrapperSub<SUB> likeLeft(MultiFunction<SUB, VAL> prop, VAL value) {
        this.wrapperSubInner.likeLeft(prop, value);
        return this;
    }
    ...
    public <VAL> MultiWrapperSub<SUB> ne(Boolean condition, MultiFunction<SUB, VAL> prop, VAL value) {
        this.wrapperSubInner.ne(condition, prop, value);
        return this;
    }
