...
public class MultiWrapperMain<MAIN> {
    ...
    protected MultiWrapperMainInner<MAIN, ?> getWrapperMainInner() {
        return wrapperMainInner;
    }

    //    public static <MAIN> MultiWrapperMain<MAIN> lambda(MAIN entity) {
//        // todo 实现过滤
//        return new MultiWrapperMain<>(MultiWrapperMainInner.<MAIN>lambda((Class<MAIN>) entity.getClass()));
//    }
    public static <MAIN> MultiWrapperMain<MAIN> lambda(Class<MAIN> clazz) {
        return new MultiWrapperMain<>(new MultiWrapperMainInner<> (clazz));
    }
    ...
    public <VAL> MultiWrapperMain<MAIN> ne(MultiFunction<MAIN, VAL> prop, VAL value) {
        wrapperMainInner.ne(prop, value);
        return this;
    }
    ...
    public final <VAL> MultiWrapperMain<MAIN> in(MultiFunction<MAIN, VAL> prop, Collection<VAL> values) {
    ...
    public <VAL> MultiWrapperMain<MAIN> likeLeft(MultiFunction<MAIN, VAL> prop, VAL value) {
        wrapperMainInner.likeLeft(prop, value);
        return this;
    }
    ...
    public <VAL> MultiWrapperMain<MAIN> ne(Boolean condition, MultiFunction<MAIN, VAL> prop, VAL value) {
        wrapperMainInner.ne(condition, prop, value);
        return this;
    }
    ...
    public <VAL> MultiWrapperMain<MAIN> ge(Boolean condition, String prop, VAL value) {
    ...
    public <VAL> MultiWrapperMain<MAIN> le(Boolean condition, String prop, VAL value) {
        wrapperMainInner.le(condition, prop, value);
        return this;
    }
    ...
    public MultiWrapperMain<MAIN> limit(long offset, long size, List<OrderItem> orderInfos) {
